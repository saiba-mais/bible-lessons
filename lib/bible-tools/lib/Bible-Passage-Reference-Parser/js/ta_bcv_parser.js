(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:எசே(?:க்(?:கியேல்(?:[\\s\\xa0]*தீர்க்கதரிசியின்[\\s\\xa0]*புத்தகம்)?)?)?|E(?:c[eē]kkiy[eē]l|zek)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
      ...
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:செப்ப[ணன]ியா|Ceppa[nṉ]iy[aā]|செப்|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
      ...
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:எபி(?:ர(?:ே(?:யர(?:ுக்கு[\\s\\xa0]*எழுதிய[\\s\\xa0]*(?:திருமுக|கடித)ம)?்)?|ெயர(?:ுக்கு[\\s\\xa0]*எழுதிய[\\s\\xa0]*நிருபம)?்))?|Epireyarukku[\\s\\xa0]*E[lḻ]utiya[\\s\\xa0]*Nirupam|Epireyarukku|Heb))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
