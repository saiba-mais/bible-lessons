(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:xho96))\b/gi;
  ...
  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|kwaye|ukuya)";

  bcv_parser.prototype.regexps.range_only = "(?:[\u2013\u2014-]|ukuya)";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Genesis|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Genesis|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Genesis|Gen(?:esis)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Eksodus|(?:Y(?:ezi|oo)|Eka|I[msz]i|Aba|Ii|Oo|U)Eksodus|(?:Y(?:ez|o)|Ek|I[msz]|Ab|I|O)Eksodus|E(?:ksodus|xod|ks)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
      ...
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Levitikus|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Levitikus|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Levitikus|Lev(?:itikus)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Numeri|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Numeri|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Numeri|Num(?:eri)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sir"],
      ...
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Lilo|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Lilo|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Lilo|L(?:ilo|am)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
      ...
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabas(?:eTy(?:hilelo)?|Ty(?:hilelo)?)|(?:um)?aTy(?:hilelo)?|(?:um?)?Ty(?:hilelo)?)|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Ty(?:hilelo)?|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Ty(?:hilelo)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
      ...
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Duteronomi|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Duteronomi|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Duteronomi|D(?:uteronomi|e?ut)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yoshuwa|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yoshuwa|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yoshuwa|Yoshuwa|[JY]osh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Gwebi|(?:Y(?:ezi|oo)|I[msz]i|Eka|Ii|Oo|U)Gwebi|(?:Aba?|Y(?:ez|o)|I[msz]|Ek|I|O)?Gwebi|Abagw|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Rute|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Rute|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Rute|Rut[eh]?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
      ...
      {
        osis: ["Esth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Estere|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Estere|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Estere|Es(?:tere|th|t)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Job"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yobhi|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yobhi|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yobhi|Yobhi|[JY]ob))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabas(?:eNd(?:umiso)?|Nd(?:umiso)?)|(?:um)?aNd(?:umiso)?|(?:um?)?Nd(?:umiso)?)|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Nd(?:umiso)?|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Nd(?:umiso)?|Ps)|(?:Indumiso))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Zekeliso|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Zekeliso|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Zekeliso|Prov|IMiz))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Ntshumayeli|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Ntshumayeli|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Ntshumayeli|Intsh|Eccl))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["SgThree"],
      ...
      {
        osis: ["Song"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Ngoma[\\s\\xa0]*Yazo[\\s\\xa0]*Iingoma|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Ngoma[\\s\\xa0]*Yazo[\\s\\xa0]*Iingoma|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Ngoma[\\s\\xa0]*Yazo[\\s\\xa0]*Iingoma|Song))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yeremiya|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Yeremiya|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yeremiya|Yeremiya|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Hezekile|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Hezekile|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Hezekile|Hezekile|Ezek|Hez))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Daniyeli|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Daniyeli|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Daniyeli|Dan(?:iyeli)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Hoseya|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Hoseya|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Hoseya|Hos(?:eya)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yoweli|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yoweli|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yoweli|Yoweli|Joel))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Amosi|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Amosi|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Amosi|Amosi?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Obhadiya|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Obhadiya|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Obhadiya|Ob(?:hadiya|ad)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yona|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yona|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yona|Jonah|Yona))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Mika|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Mika|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Mika|Mi(?:ka|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?UNahum|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo)UNahum|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IOU])UNahum|UNahum|Nah))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hab"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Habhakuki|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Habhakuki|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Habhakuki|Hab(?:hakuki)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Zefaniya|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Zefaniya|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Zefaniya|Ze(?:faniya|ph)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Hagayi|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Hagayi|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Hagayi|Hag(?:ayi)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Zekariya|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Zekariya|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Zekariya|Ze(?:kariya|ch)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Malaki|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Malaki|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Malaki|Mal(?:aki)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Mateyu|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Mateyu|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Mateyu|Mat(?:eyu|t)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Marko|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Marko|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Marko|Marko?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Luka|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Luka|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Luka|Luk[ae]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eYohane[\s\xa0]*[1I]|Yohane[\s\xa0]*[1I])|(?:um)?aYohane[\s\xa0]*[1I]|(?:um?)?Yohane[\s\xa0]*[1I])|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yohane[\s\xa0]*[1I]|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yohane[\s\xa0]*[1I]|1(?:\.[\s\xa0]*Y(?:ohane|h)|[\s\xa0]*Y(?:ohane|h)|John)|I(?:\.[\s\xa0]*Y(?:ohane|h)|[\s\xa0]*Y(?:ohane|h))|Yohane[\s\xa0]*[1I]|(?:1\.?|I\.?)[\s\xa0]*Yoh))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eYohane[\s\xa0]*(?:II|2)|Yohane[\s\xa0]*(?:II|2))|(?:um)?aYohane[\s\xa0]*(?:II|2)|(?:um?)?Yohane[\s\xa0]*(?:II|2))|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yohane[\s\xa0]*(?:II|2)|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yohane[\s\xa0]*(?:II|2)|II(?:\.[\s\xa0]*Y(?:ohane|h)|[\s\xa0]*Y(?:ohane|h))|2(?:\.[\s\xa0]*Y(?:ohane|h)|[\s\xa0]*Y(?:ohane|h)|John)|Yohane[\s\xa0]*(?:II|2)|(?:II\.?|2\.?)[\s\xa0]*Yoh))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eYohane[\s\xa0]*(?:III|3)|Yohane[\s\xa0]*(?:III|3))|(?:um)?aYohane[\s\xa0]*(?:III|3)|(?:um?)?Yohane[\s\xa0]*(?:III|3))|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yohane[\s\xa0]*(?:III|3)|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yohane[\s\xa0]*(?:III|3)|III(?:\.[\s\xa0]*Y(?:ohane|h)|[\s\xa0]*Y(?:ohane|h))|Yohane[\s\xa0]*(?:III|3)|3(?:\.[\s\xa0]*Y(?:ohane|h)|[\s\xa0]*Y(?:ohane|h)|John)|(?:III\.?|3\.?)[\s\xa0]*Yoh))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yohane|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Oo|Ii|U)Yohane|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yohane|Yohane|John|Yoh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Zenzo|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Zenzo|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Zenzo|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Roma|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Roma|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Roma|Roma?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eKorinte[\s\xa0]*(?:II|2)|Korinte[\s\xa0]*(?:II|2))|(?:um)?aKorinte[\s\xa0]*(?:II|2)|(?:um?)?Korinte[\s\xa0]*(?:II|2)|orinte[\s\xa0]*(?:II|2))|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Korinte[\s\xa0]*(?:II|2)|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Korinte[\s\xa0]*(?:II|2)|(?:II\.?[\s\xa0]*K|2(?:\.[\s\xa0]*K|[\s\xa0]*K|C))or))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eKorinte[\s\xa0]*[1I]|Korinte[\s\xa0]*[1I])|(?:um)?aKorinte[\s\xa0]*[1I]|(?:um?)?Korinte[\s\xa0]*[1I]|orinte[\s\xa0]*[1I])|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Korinte[\s\xa0]*[1I]|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Korinte[\s\xa0]*[1I]|(?:1(?:\.[\s\xa0]*K|[\s\xa0]*K|C)|I\.?[\s\xa0]*K)or))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Galati|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Galati|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Galati|Gal(?:ati)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Efese|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Efese|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Efese|E(?:fese|ph)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Filipi|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Filipi|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Filipi|Filip[iu]|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?Kolose|(?:um)?aKolose|(?:um?)?Kolose|ol(?:ose)?)|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Kolose|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Kolose|Col))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eTesalonika[\s\xa0]*(?:II|2)|Tesalonika[\s\xa0]*(?:II|2))|(?:um)?aTesalonika[\s\xa0]*(?:II|2)|(?:um?)?Tesalonika[\s\xa0]*(?:II|2))|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Tesalonika[\s\xa0]*(?:II|2)|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Tesalonika[\s\xa0]*(?:II|2)|II(?:\.[\s\xa0]*T(?:esalonika|s)|[\s\xa0]*T(?:esalonika|s))|2(?:\.[\s\xa0]*T(?:esalonika|s)|[\s\xa0]*T(?:esalonika|s)|Thess)|(?:II\.?|2\.?)[\s\xa0]*Tes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eTesalonika[\s\xa0]*[1I]|Tesalonika[\s\xa0]*[1I])|(?:um)?aTesalonika[\s\xa0]*[1I]|(?:um?)?Tesalonika[\s\xa0]*[1I])|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Tesalonika[\s\xa0]*[1I]|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Tesalonika[\s\xa0]*[1I]|1(?:\.[\s\xa0]*T(?:esalonika|s)|[\s\xa0]*T(?:esalonika|s)|Thess)|I(?:\.[\s\xa0]*T(?:esalonika|s)|[\s\xa0]*T(?:esalonika|s))|(?:1\.?|I\.?)[\s\xa0]*Tes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eTimoti[\s\xa0]*(?:II|2)|Timoti[\s\xa0]*(?:II|2))|(?:um)?aTimoti[\s\xa0]*(?:II|2)|(?:um?)?Timoti[\s\xa0]*(?:II|2))|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Timoti[\s\xa0]*(?:II|2)|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Timoti[\s\xa0]*(?:II|2)|(?:II\.?[\s\xa0]*|2(?:\.[\s\xa0]*|[\s\xa0]*)?)Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:eTimoti[\s\xa0]*[1I]|Timoti[\s\xa0]*[1I])|(?:um)?aTimoti[\s\xa0]*[1I]|(?:um?)?Timoti[\s\xa0]*[1I])|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Timoti[\s\xa0]*[1I]|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Timoti[\s\xa0]*[1I]|(?:1(?:\.[\s\xa0]*|[\s\xa0]*)?|I\.?[\s\xa0]*)Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Tito|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Tito|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Tito|Tit(?:us|o)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Filemon|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Filemon|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Filemon|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Hebhere|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Hebhere|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Hebhere|Heb(?:here)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yakobi|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Yakobi|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yakobi|Yakobi|Jas))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:\.[\s\xa0]*Pe?|[\s\xa0]*Pe?)tr)|(?:K(?:wabas(?:ePetros[\s\xa0]*(?:II|2)|Petros[\s\xa0]*(?:II|2))|(?:um)?aPetros[\s\xa0]*(?:II|2)|(?:um?)?Petros[\s\xa0]*(?:II|2))|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Petros[\s\xa0]*(?:II|2)|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Petros[\s\xa0]*(?:II|2)|II(?:\.[\s\xa0]*Pe?|[\s\xa0]*Pe?)tr|II(?:\.[\s\xa0]*Pe?|[\s\xa0]*Pe?)t|2(?:\.[\s\xa0]*Pe?|[\s\xa0]*Pe?|Pe)t))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:K(?:wabas(?:ePetros[\s\xa0]*[1I]|Petros[\s\xa0]*[1I])|(?:um)?aPetros[\s\xa0]*[1I]|(?:um?)?Petros[\s\xa0]*[1I])|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Petros[\s\xa0]*[1I]|(?:Y(?:ez|o)|I[msz]|Ek|Ab|I|O)?Petros[\s\xa0]*[1I]|1(?:\.[\s\xa0]*Pe?tr|[\s\xa0]*Pe?tr|Pet)|I(?:\.[\s\xa0]*Pe?|[\s\xa0]*Pe?)tr|(?:1(?:\.[\s\xa0]*Pe?|[\s\xa0]*Pe?)|I(?:\.[\s\xa0]*Pe?|[\s\xa0]*Pe?))t))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:wabase?|(?:um)?a|um?)?Yuda|(?:Y(?:ezi|oo)|I[msz]i|(?:Ek|Ab)a|Ii|Oo|U)Yuda|(?:Y(?:ez|o)|I[msz]|Ek|Ab|[IO])Yuda|Jude|Yuda))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c60 = "isahluko",
        peg$c61 = peg$literalExpectation("isahluko", false),
        peg$c62 = function() { return {"type": "c_explicit"} },
        peg$c63 = "ivesi",
        peg$c64 = peg$literalExpectation("ivesi", false),
        ...
        peg$c72 = "kwaye",
        peg$c73 = peg$literalExpectation("kwaye", false),
        peg$c74 = function() { return "" },
        peg$c75 = /^[\-\u2013\u2014]/,
        peg$c76 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c77 = "ukuya",
        peg$c78 = peg$literalExpectation("ukuya", false),
        peg$c79 = "title",
