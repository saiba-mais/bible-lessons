(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ղ(?:եւտական|ևտացոց)|Lev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
      ...
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Երկրորդ[\\s\\xa0]*Օ(?:րէնք|ինաց)|Deut))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Նաւէի[\\s\\xa0]*որդի[\\s\\xa0]*Յեսուի[\\s\\xa0]*գիրքը|Յեսու|Josh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
      ...
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Թագաւորութիւններ[\s\xa0]*Բ|2(?:\.[\s\xa0]*Թագավորաց|[\s\xa0]*Թագավորաց|Sam)|Բ[\s\xa0]*Թագավորաց))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Թագաւորութիւններ[\s\xa0]*Ա|1(?:\.[\s\xa0]*Թագավորաց|[\s\xa0]*Թագավորաց|Sam)|Ա[\s\xa0]*Թագավորաց))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Թագաւորութիւններ[\s\xa0]*Դ|4\.?[\s\xa0]*Թագավորաց|Դ[\s\xa0]*Թագավորաց|2Kgs))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Թագաւորութիւններ[\s\xa0]*Գ|3\.?[\s\xa0]*Թագավորաց|Գ[\s\xa0]*Թագավորաց|1Kgs))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Դաւթի[\\s\\xa0]*սաղմոսների[\\s\\xa0]*գիրքը|Սաղմոս|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Dan"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Դանիէլ(?:ի[\\s\\xa0]*մարգարէութիւնը)?|Dan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hos"],
      ...
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Պողոս[\\s\\xa0]*Առաքեալի[\\s\\xa0]*թուղթը[\\s\\xa0]*հռոմէացիներին|Հռոմէացիներին|Հռոմեացիս|Rom))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Պողոս[\s\xa0]*Առաքեալի[\s\xa0]*երկրորդ[\s\xa0]*թուղթը[\s\xa0]*կորնթացիներին|Կորնթացիներին[\s\xa0]*Բ|2(?:\.[\s\xa0]*Կորնթացիս|[\s\xa0]*Կորնթացիս|Cor)|Բ[\s\xa0]*Կորնթացիս))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Պողոս[\s\xa0]*Առաքեալի[\s\xa0]*առաջին[\s\xa0]*թուղթը[\s\xa0]*կորնթացիներին|Կորնթացիներին[\s\xa0]*Ա|1(?:\.[\s\xa0]*Կորնթացիս|[\s\xa0]*Կորնթացիս|Cor)|Ա[\s\xa0]*Կորնթացիս))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
      ...
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Պողոս[\\s\\xa0]*Առաքեալի[\\s\\xa0]*թուղթը[\\s\\xa0]*փիլիպեցիներին|Փիլիպեցիներին|Փիլիպպեցիս|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
      ...
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Պողոս[\s\xa0]*Առաքեալի[\s\xa0]*երկրորդ[\s\xa0]*թուղթը[\s\xa0]*թեսաղոնիկեցիներին|Թեսաղոնիկեցիներին[\s\xa0]*Բ|2(?:\.[\s\xa0]*Թեսաղոնիկեցիս|[\s\xa0]*Թեսաղոնիկեցիս|Thess)|Բ[\s\xa0]*Թեսաղոնիկեցիս))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Պողոս[\s\xa0]*Առաքեալի[\s\xa0]*առաջին[\s\xa0]*թուղթը[\s\xa0]*թեսաղոնիկեցիներին|Թեսաղոնիկեցիներին[\s\xa0]*Ա|1(?:\.[\s\xa0]*Թեսաղոնիկեցիս|[\s\xa0]*Թեսաղոնիկեցիս|Thess)|Ա[\s\xa0]*Թեսաղոնիկեցիս))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Պողոս[\s\xa0]*Առաքեալի[\s\xa0]*երկրորդ[\s\xa0]*թուղթը[\s\xa0]*Տիմոթէոսին|Տիմոթէոսին[\s\xa0]*Բ|2Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Պողոս[\s\xa0]*Առաքեալի[\s\xa0]*առաջին[\s\xa0]*թուղթը[\s\xa0]*Տիմոթէոսին|Տիմոթէոսին[\s\xa0]*Ա|1Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
      ...
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Թուղթ[\\s\\xa0]*եբրայեցիներին|Եբրայեցիներին|Եբրայեցիս|Heb))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
      ...
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Յուդա(?:[\\s\\xa0]*Առաքեալի[\\s\\xa0]*ընդհանրական[\\s\\xa0]*թուղթը)?|Jude))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
