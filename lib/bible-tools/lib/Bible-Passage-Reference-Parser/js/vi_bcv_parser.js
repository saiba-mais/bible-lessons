(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Khải(?:[\\s\\xa0]*(?:Huyền(?:[\\s\\xa0]*của[\\s\\xa0]*John)?|thị)|\\-?huyền)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
      ...
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Phục(?:[\\s\\xa0]*(?:truyền[\\s\\xa0]*luật[\\s\\xa0]*lệ[\\s\\xa0]*k\\xFD|Truyền(?:[\\s\\xa0]*Luật[\\s\\xa0]*Lệ)?)|\\-?truyền)?|(?:Đệ[\\s\\xa0]*nhị[\\s\\xa0]*luậ|Deu)t))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Th(?:\\xE1nh[\\s\\xa0]*(?:vịnh|Thi)|i(?:(?:\\-?t|[\\s\\xa0]*T)hi\\xEAn)?)|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:C\\xF4ng(?:[\\s\\xa0]*(?:vụ[\\s\\xa0]*(?:c\\xE1c[\\s\\xa0]*Sứ|T\\xF4ng)[\\s\\xa0]*đồ|Vụ)|\\-?vụ)?|Sứ[\\s\\xa0]*đồ|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
