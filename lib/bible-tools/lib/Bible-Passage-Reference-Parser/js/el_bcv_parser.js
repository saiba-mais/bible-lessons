(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Π(?:αρ(?:οιμ[ίι](?:ες|αι))?|ρμ)|Prov))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
      ...
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Μ(?:ΙΧΑ(?:Ϊ́|Ί?|Ί)ΑΣ|ιχα[ΐίι]ας|ιχ|χ)|Mic))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
